...
class Note extends Sprite
{
	...
	public var customNoteID:Int = 0;

	public function new(strumTime:Float, noteData:Int, ?eventNote:Bool, ?prevNote:Note, ?sustainNote:Bool = false, ?noteSkin:String = "", ?customNoteID:Int = 0)
	{
		super();
		...
		switch (customNoteID)
		{
			...
			case 1:
				frames = Paths.getSparrowAtlas("noteskins/NOTE_blaze");
				...
				antialiasing = true;
			case 2:
				frames = Paths.getSparrowAtlas("noteskins/NOTE_chara");
				...
				antialiasing = true;
			case 3:
				frames = Paths.getSparrowAtlas("noteskins/NOTE_corru");
				...
				antialiasing = true;
			case 4:
				frames = Paths.getSparrowAtlas("noteskins/NOTE_crunchy");
				...
				antialiasing = true;
			case 5:
				frames = Paths.getSparrowAtlas("noteskins/NOTE_para");
